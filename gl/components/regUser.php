...
function sendMess($inf)
{
	...
	$mess = 'Здравствуйте, вы зарегистрировались на сайте отопление-дома-своими-руками.рф ( <a href="'.$url.'/calculator/warm_floor">программа теплый пол 3D</a> ). Чтобы закончить регистрацию, пройдите по <a href="'.$url.'/active_1/'.$inf['token'].'">ссылке</a>.<br><br>';	
