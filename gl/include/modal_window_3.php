...
<div class="background_main_menu" nameId="background_main_menu" ui_1="">
	<div class="modal_wrap">
		<div class="window_main_menu" nameId="window_main_menu">
			<div style="position: absolute; width: 20px; height: 20px; top: 10px; right: 10px; transform: rotate(-45deg); font-size: 30px; text-align: center; text-decoration: none; line-height: 0.6em; color: #666; cursor: pointer;" nameId="button_close_main_menu">
				+
			</div>
			<div style="display: flex; align-items: center; justify-content: space-between; height: 40px; background: #e8e8e8; border-bottom: 2px solid #f2f2f2; padding-right: 30px;">
				<div class="modal_title" style="display: flex; flex-direction: column; justify-content: center; height: 29px; margin-top: 0.3em; padding-left: 20px; font-size: 18px;color: #666;">
					<div>
						...
						<div class="window_main_menu_content_1_row">
							...
							<div class="window_main_menu_content_1_column" style="position: relative;">
								...
								<div wwm_1="button_help" style="display: none;">
									...
									<div class="modal_wind_2" style="margin: 30px; font-size: 15px;">
										Приветствуем.<br> 
									...
									<div class="modal_wind_2" style="margin: 30px; font-size: 15px;">
										Посмотрите видео, как пользоваться программой:

										<div class="flex_1">
											<a href="https://rutube.ru/video/c0dfef93a75bb585db6d8533d81fa99c/" class="button_youtube_1 button_gradient_1" style="height: 160px;" target="_blank">
												<img src="<?=$path?>img/r1.jpg">
											</a>					
											<a href="https://rutube.ru/video/1e734516806a4b91f174dbee7c0e7251/" class="button_youtube_1 button_gradient_1" style="height: 160px;" target="_blank">
												<img src="<?=$path?>img/r2.jpg">
											</a>											
										</div>					
									</div>		
								</div>
